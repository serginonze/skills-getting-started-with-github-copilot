...
activities = {
    ...
    "Soccer Club": {
        "description": "Train for soccer matches and develop athletic skills",
    ...
    "Drama Club": {
        "description": "Rehearse scenes and perform in school theater productions",
    ...
    "Debate Team": {
        "description": "Build persuasive speaking skills and compete in debates",
